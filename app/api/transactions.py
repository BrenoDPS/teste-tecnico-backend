...
from ..schemas.base import PurchanceCreate, Purchance
...
async def get_transaction(
    ...
    Requer autenticação.
    """
    transaction = db.query(DimPurchances).filter(DimPurchances.purchance_id == purchance_id).first()
    if not transaction:
        raise HTTPException(
...
async def update_transaction(
    ...
    Requer autenticação.
    """
    db_transaction = db.query(DimPurchances).filter(DimPurchances.purchance_id == purchance_id).first()
