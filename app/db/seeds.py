...
from ..models.models import DimSupplier, DimLocations, DimVehicle, DimParts, DimPurchances, FactWarranties
...
def seed_suppliers(db: Session):
    suppliers = [
        {
            "supplier_name": "Auto Peças Silva",
            "location_id": 1
        },
        {
            "supplier_name": "Peças e Cia",
            "location_id": 2
        },
        {
...
def seed_parts(db: Session):
    parts = [
        ...
        {
            "part_name": "Kit Suspensão",
            "last_id_purchase": 2,
            "supplier_id": 2
        },
        {
            "part_name": "Motor Elétrico",
            "last_id_purchase": 3,
            "supplier_id": 3
        }
    ]
...
def seed_purchances(db: Session):
    purchances = [
        {
            "purchance_type": "COMPRA",
            "purchance_date": date(2024, 3, 1),
            "part_id": 1
        },
        {
