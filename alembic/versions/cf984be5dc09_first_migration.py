...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_dim_locations_location_id"),
        "dim_locations",
        ["location_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_dim_vehicle_vehicle_id"), "dim_vehicle", ["vehicle_id"], unique=False
    )
    op.create_table(
        "dim_supplier",
    ...
    op.create_index(
        op.f("ix_dim_supplier_supplier_id"),
        "dim_supplier",
        ["supplier_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_dim_parts_part_id"), "dim_parts", ["part_id"], unique=False
    )
    op.create_table(
        "dim_purchances",
    ...
    op.create_index(
        op.f("ix_dim_purchances_purchance_id"),
        "dim_purchances",
        ["purchance_id"],
        unique=False,
    )
