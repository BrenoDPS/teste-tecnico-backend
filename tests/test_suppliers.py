...
def test_read_supplier(client: TestClient, test_supplier: dict, auth_headers: dict, db: Session):
...
def test_list_suppliers(client: TestClient, test_supplier: dict, auth_headers: dict, db: Session):
...
def test_update_supplier(client: TestClient, test_supplier: dict, auth_headers: dict, db: Session):
    # Criar um fornecedor para teste
    db_supplier = DimSupplier(**test_supplier)
    db.add(db_supplier)
    db.commit()
...
def test_delete_supplier(client: TestClient, test_supplier: dict, auth_headers: dict, db: Session):
    # Criar um fornecedor para teste
    db_supplier = DimSupplier(**test_supplier)
    db.add(db_supplier)
    db.commit()
